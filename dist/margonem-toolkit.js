...
`);
  ...
  function reloadCharacter(hero, page2, navigate = (url) => page2.location.replace(url)) {
    ...
    try {
      ...
      console.warn("[QADDONS Przelogawka] Nie udało się zatrzymać poprzedniej sesji gry.", cause);
    }
    navigate(target.url);
    return "reload";
  }

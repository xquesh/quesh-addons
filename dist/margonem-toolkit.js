...
`);
  ...
  var defaults4 = { sort: "level-desc", horizontal: 100, showWorldButton: true, showTimers: true, hotkeys: false, selectedWorld: "" };
...
`;
  ...
  function startRelogger(ctx) {
    ...
    function position() {
      ...
      bar.style.top = `${Math.max(0, Math.min(page2.innerHeight - height, bottom - height - 2))}px`;
